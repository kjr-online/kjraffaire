...
$hookmanager->initHooks(array('kjr_projectcontact'));
...
if ($id) {
	...
	print dol_get_fiche_head($head, 'affairesContact', $langs->trans("affaires"), -1, 'contact');
	...
	// Projects list
	$result = kjr_show_contacts_affaires($conf, $langs, $db, $object, $_SERVER["PHP_SELF"].'?id='.$object->id, 1);
}
