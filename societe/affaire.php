...
$hookmanager->initHooks(array('kjr_projectthirdparty'));
...
if ($socid) {
	...
	$newcardbutton = dolGetButtonTitle($langs->trans("NewProject"), '', 'fa fa-plus-circle', DOL_URL_ROOT.'/custom/kjraffaire/affaire/card.php?action=create&socid='.$object->id.'&backtopageforcancel='.urlencode($backtopage), '', 1, $params);
	...
	$result = kjr_show_affaires($conf, $langs, $db, $object, $_SERVER["PHP_SELF"].'?socid='.$object->id, 1, $newcardbutton);
