...
/**
 * \file    core/triggers/interface_99_modKjraffaire_KjraffaireTriggers.class.php
 * \ingroup kjraffaire
 ...
 *      - interface_99_modKjraffaire_MyTrigger.class.php
...
/**
 *  Class of triggers for Kjraffaire module
 */
class InterfaceKjraffaireTriggers extends DolibarrTriggers
{
	/**
	 * Constructor
	 *
	...
	public function __construct($db)
	{
		...
		$this->family = "demo";
		$this->description = "Kjraffaire triggers.";
		$this->version = self::VERSIONS['dev'];
		$this->picto = 'kjraffaire@kjraffaire';
	}
